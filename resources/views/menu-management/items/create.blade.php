                    ...
                    <form id="itemForm" class="" action="{{ route('user.menu.item.store') }}" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control ltr" name="price" min ="1"
                                        step ="1" value="" placeholder="Enter Current Price">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea id="postContent" class="form-control summernote" name="description" placeholder="{{ __('Enter Content') }}"
